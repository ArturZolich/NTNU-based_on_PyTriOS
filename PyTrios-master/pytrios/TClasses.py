...
class TPacket(object):
    ...
    def QInterp(self):
        ...
        print("SERIAL TID: ", tchannel.TInfo.TID, end="\t")
        print("SERIAL NUMBER: ", tchannel.TInfo.serialn, end="\t")
        print("SERIAL ModuleType: ", tchannel.TInfo.ModuleType, end="\t")
        print("SERIAL Firmware: ", tchannel.TInfo.Firmware, end="\t")
        print("SERIAL ModFreq: ", tchannel.TInfo.ModFreq, end="\t")
